...
const RegisterPage = () => {
    ...
    return (
        ...
        <input type="text" className="grow" placeholder="Username" value={userData.username} onChange={(e:any)=> setUserData({...userData, username:e.target.value})}/>
        </label>
        ...
        <input type="password" className="grow" value={userData.password} onChange={(e: any)=> setUserData({... userData, password: e.target.value})} />
        </label>
